...
export const converters: Converter[] = [
  // Document (1-15)
  { id: 1, from: "PDF", to: "Word", category: "document", icon: "📄", popular: true },
  { id: 2, from: "Word", to: "PDF", category: "document", icon: "📝", popular: true },
  { id: 3, from: "PDF", to: "Excel", category: "document", icon: "📊", popular: true },
  ...
  { id: 9, from: "Word", to: "Text", category: "document", icon: "📝" },
  { id: 10, from: "Text", to: "Word", category: "document", icon: "✍️" },
  { id: 11, from: "PDF", to: "HTML", category: "document", icon: "🌐" },
  { id: 12, from: "HTML", to: "PDF", category: "document", icon: "📄" },
  { id: 13, from: "Word", to: "HTML", category: "document", icon: "🔤" },
  ...
  { id: 18, from: "Excel", to: "JSON", category: "data", icon: "🗃️" },
  { id: 19, from: "JSON", to: "Excel", category: "data", icon: "📋" },
  { id: 20, from: "CSV", to: "JSON", category: "data", icon: "🔄", popular: true },
  { id: 21, from: "JSON", to: "CSV", category: "data", icon: "📤" },
  { id: 22, from: "XML", to: "JSON", category: "data", icon: "🔀" },
  ...
  { id: 33, from: "PDF", to: "Image", category: "image", icon: "🖼️" },
  { id: 34, from: "SVG", to: "PNG", category: "image", icon: "✏️" },
  ...
  // OCR (41-45)
  { id: 41, from: "Image", to: "Text", category: "ocr", icon: "🔍", popular: true },
  ...
  { id: 47, from: "AVI", to: "MP4", category: "video", icon: "🎥", popular: true },
  { id: 48, from: "MKV", to: "MP4", category: "video", icon: "📹", popular: true },
  ...
  // Audio (56-60)
  { id: 56, from: "MP3", to: "WAV", category: "audio", icon: "🎵" },
  { id: 57, from: "WAV", to: "MP3", category: "audio", icon: "🎶", popular: true },
  { id: 58, from: "AAC", to: "MP3", category: "audio", icon: "🎧" },
  { id: 59, from: "FLAC", to: "MP3", category: "audio", icon: "🎼" },
  { id: 60, from: "Audio", to: "Text", category: "audio", icon: "📝", popular: true },
  // Web (61-65)
  { id: 61, from: "HTML", to: "Image", category: "web", icon: "🌐" },
  { id: 62, from: "Website", to: "PDF", category: "web", icon: "📄", popular: true },
  { id: 63, from: "Markdown", to: "HTML", category: "web", icon: "📝" },
  { id: 64, from: "HTML", to: "Markdown", category: "web", icon: "🔤" },
  { id: 65, from: "JSON", to: "CSV", category: "web", icon: "📊" },
  // File (66-70)
