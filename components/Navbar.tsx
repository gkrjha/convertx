      ...
      <div className="max-w-7xl mx-auto px-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="md:hidden w-9 h-9 flex items-center justify-center glass rounded-xl text-white/60 hover:text-white transition-colors"
        ...
        <div className="md:hidden glass-strong border-t border-white/8 px-5 py-4 flex flex-col gap-1 mt-0">
          {links.map((l) => (
            <a
              ...
              className="text-white/60 hover:text-white hover:bg-white/5 px-3 py-2.5 rounded-xl text-sm transition-colors"
            >
              {l.label}
            </a>
          ))}
