...
function HomeJsonLd() {
  const faqSchema = {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: "What file formats does ConvertX support?",
        acceptedAnswer: { "@type": "Answer", text: "ConvertX supports 70+ conversions including PDF, Word, Excel, JPG, PNG, WebP, MP4, MP3, CSV, JSON, XML and more." },
      },
    ],
  };
  ...
  const webAppSchema = {
    "@context": "https://schema.org",
    "@type": "WebApplication",
    name: "ConvertX — Free Online File Converter",
    ...
    screenshot: "https://convertx.app/scanner.svg",
    aggregateRating: {
  ...
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://convertx.app" },
      { "@type": "ListItem", position: 2, name: "File Converters", item: "https://convertx.app/#converters" },
    ],
  };
